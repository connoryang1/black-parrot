...
The fork's `master` contains separate upstream changes. Use the companion's
pinned submodule revision or the accepted branch, not an arbitrary latest branch.
