  ...
  always_comb
    begin
      ...
      struct_haz_v = cmd_haz_v
                     ...
                     // Keep a hint at dispatch while the memory pipe is busy.
                     // The hint is advisory after acceptance, but silently
                     // retiring it here destroys sustained prefetch coverage.
